            ...
            html: `
                <div class="text-left text-sm">
                    ...
                    <div class="mt-2 p-2 bg-yellow-50 rounded-lg">
                        <p class="font-semibold text-yellow-700">📢 La prédiction finale de ${predictionResult.finalOdds} devrait apparaître dans l'un des 3 rounds suivants</p>
                    </div>
                </div>
            `,
            toast: true,
    ...
    document.getElementById('result').innerHTML = `
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div class="text-center p-3 bg-yellow-50 rounded-lg">
                ...
                <p class="text-xl font-bold text-yellow-600">${prediction.rawOdds}</p>
            </div>
            
            <div class="text-center p-3 bg-yellow-50 rounded-lg">
                <span class="text-xs text-gray-600 block mb-1">Prédiction Finale</span>
                <p class="text-2xl font-bold text-yellow-600">${prediction.finalOdds}</p>
            </div>
                    ...
                    <div class="flex justify-between items-start">
                        <div>
                            ...
                            <p class="text-xs text-gray-600">
                                Prédiction: 
                                <span class="font-bold text-yellow-600">${prediction.finalOdds}</span> 
...
function toggleHistoryVisibility() {
    ...
    if (isHistoryVisible) {
        ...
        toggleButton.classList.add('bg-yellow-500');
    } else {

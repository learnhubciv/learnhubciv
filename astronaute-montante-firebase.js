...
// Configuration Firebase (MÊME QUE DANS jeux.html)
...
// CORRIGÉ: Vérifier la licence de l'utilisateur pour le jeu Astronaute
async function checkUserLicense(userId) {
    ...
    try {
        ...
        if (querySnapshot.empty) {
            ...
            showLicenseMessage("Licence non trouvée", "Vous n'avez pas acheté le jeu Astronaute", true);
        ...
        querySnapshot.forEach((doc) => {
            ...
            // CORRECTION: Vérifier si la licence est active ET non expirée
        ...
        userInfoElement.innerHTML = `
            <div class="flex items-center">
                ...
                <div class="text-left">
                    ...
                    <p class="user-subtitle">Bot Crash Pro</p>
                </div>
            </div>
        `;
    }

        ...
        html: `
            <div class="text-left">
                ...
                <div class="mt-2 p-2 bg-red-50 rounded-lg border border-red-200">
                    <p class="font-semibold text-red-700">📢 La prédiction finale de ${predictionResult.finalOdds} devrait apparaître dans l'un des 3 rounds suivants</p>
                </div>
            </div>
        `,
        toast: true,
    ...
    if (prediction.betAmount > 0) {
        potentialWinHTML = `
            <div class="mt-4 text-center">
                ...
                <p class="text-2xl font-bold text-red-600">${prediction.potentialWin} €</p>
    ...
    document.getElementById('result').innerHTML = `
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div class="text-center p-3 bg-red-50 rounded-lg">
                ...
                <p class="text-xl font-bold text-red-600">${prediction.rawOdds}</p>
            </div>
            
            <div class="text-center p-3 bg-red-100 rounded-lg">
                <span class="text-xs text-gray-600 block mb-1">Prédiction Finale</span>
                <p class="text-2xl font-bold text-red-700">${prediction.finalOdds}</p>
            </div>
            
            <div class="text-center p-3 bg-red-50 rounded-lg">
                <span class="text-xs text-gray-600 block mb-1">Probabilité de Réussite</span>
                <p class="text-xl font-bold text-red-600">${prediction.probabilities[0]}%</p>
            </div>
        </div>
        ...
        <div class="mt-4">
            <div class="flex justify-between mb-1">
                ...
                <span class="text-sm font-bold text-red-600">${prediction.globalScore}</span>
            </div>
            <div class="w-full bg-gray-200 rounded-full h-2">
                <div class="bg-red-600 h-2 rounded-full" style="width: ${prediction.globalScore * 100}%"></div>
            </div>
        </div>
                    ...
                    <div class="flex justify-between items-start">
                        <div>
                            ...
                            <p class="text-xs text-gray-600">
                                Prédiction: 
                                <span class="font-bold text-red-600">${prediction.finalOdds}</span> 
    ...
    document.getElementById('intelligentAnalysis').innerHTML = `
        <div class="space-y-3">
            <div class="p-2 bg-red-50 rounded-lg">
                <div class="font-bold text-red-800 mb-1 text-sm">
                    ...
                    <div class="space-y-1">
                        <div class="flex items-center">
                            ...
                            <div class="flex-1 bg-gray-200 rounded-full h-1.5">
                                <div class="bg-red-600 h-1.5 rounded-full" style="width: ${(oddsRanges['1.0-1.5'] / successfulPredictions.length) * 100}%"></div>
                            </div>
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="flex-1 bg-gray-200 rounded-full h-1.5">
                                <div class="bg-red-600 h-1.5 rounded-full" style="width: ${(oddsRanges['1.5-2.0'] / successfulPredictions.length) * 100}%"></div>
                            </div>
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="flex-1 bg-gray-200 rounded-full h-1.5">
                                <div class="bg-red-600 h-1.5 rounded-full" style="width: ${(oddsRanges['2.0-2.5'] / successfulPredictions.length) * 100}%"></div>
                            </div>
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="flex-1 bg-gray-200 rounded-full h-1.5">
                                <div class="bg-red-600 h-1.5 rounded-full" style="width: ${(oddsRanges['2.5+'] / successfulPredictions.length) * 100}%"></div>
                            </div>

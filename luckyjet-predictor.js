...
async function fetchLatestCoefficient() {
    try {
        ...
        // Récupération directe depuis l'API (système du deuxième fichier)
        ...
        if (data && data.stopCoefficients && data.stopCoefficients.length > 0) {
            ...
            // Vérifier les doublons (système du deuxième fichier)
...
function predictAutoOdds(autoTriggered = false) {
    ...
    try {
        // Utiliser le système de prédiction du deuxième fichier

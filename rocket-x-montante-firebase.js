...
onAuthStateChanged(auth, async (user) => {
    if (user) {
        ...
        // Vérifier la licence pour Rocket X
...
async function checkUserLicense(userId) {
    ...
    try {
        ...
        if (querySnapshot.empty) {
            ...
            showLicenseMessage("Licence non trouvée", "Vous n'avez pas acheté le jeu Rocket X", true);
        ...
        userInfoElement.innerHTML = `
            <div class="flex items-center">
                ...
                <div class="text-left">
                    ...
                    <p class="user-subtitle">Prédicteur Rocket X Pro</p>
                </div>
            </div>
        `;
    }
